...
- Standardized jar file naming to `shulkersorter-<loader>-<version>+mc<range>.jar` (e.g. `shulkersorter-fabric-1.2.0+mc1.21-1.21.5.jar`, `shulkersorter-neoforge-1.2.0+mc1.21-1.21.5.jar`)
