...
- Standardized jar file naming to `shulkersorter-<loader>-<version>+mc<range>.jar` (e.g. `shulkersorter-fabric-1.2.0+mc26.2.jar`, `shulkersorter-neoforge-1.2.0+mc26.2.jar`)
